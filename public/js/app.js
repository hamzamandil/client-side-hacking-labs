...
const LABS = [
  ...
  { id: 'elmahdi-cookie-xss', category: 'advanced-xss', title: 'Accelr: Cookie Overwrite Bypass', description: 'The /login endpoint overwrites the lang cookie server-side, blocking cookie-based XSS. But another endpoint uses the same vulnerable JS without the protection. Find the unpatched path and exploit.', difficulty: 'hard', tags: ['cookie', 'Set-Cookie bypass', 'DOM XSS', 'endpoint inconsistency'], url: '/elmahdi/login' },
  { id: 'elmahdi-chrome-quirk', category: 'advanced-xss', title: 'PayFlow: Chrome innerHTML Quirk', description: 'A checkout page "safely" decodes HTML-encoded postMessage data using a detached <p> element. The developer thought this was safe. Chrome disagrees — image onerror handlers fire even on detached elements.', difficulty: 'expert', tags: ['postMessage', 'Chrome quirk', 'detached element', 'innerHTML'], url: '/elmahdi/checkout' },
